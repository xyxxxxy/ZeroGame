...
class UFooBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, Category = "Foo | Lens Distortion", meta = (DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin."))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Foo | Lens Distortion", meta = (DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin.", WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintPure, meta=(DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin.", DisplayName = "Equal (LensDistortionCameraModel)", CompactNodeTitle = "==", Keywords = "== equal"), Category = "Foo | Lens Distortion")
	...
	UFUNCTION(BlueprintPure, meta = (DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin.", DisplayName = "NotEqual (LensDistortionCameraModel)", CompactNodeTitle = "!=", Keywords = "!= not equal"), Category = "Foo | Lens Distortion")
