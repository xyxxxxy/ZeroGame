...
#include "DetailCustomizations/DialogueSocketCustomizationBase.h"

/**
* Property customization for the Dialogue Speaker Socket which allows for
* a speaker to be selected from the graph.
*/
class FDialogueSpeakerSocketCustomization : public FDialogueSocketCustomizationBase
{
public:
	/**
...
protected:
	...
	virtual void CachePrerequisites(TSharedRef<IPropertyHandle> PropertyHandle) override;
	...
	virtual void SetUpPropertyChangeEvent(TSharedRef<IPropertyHandle> PropertyHandle) override;
