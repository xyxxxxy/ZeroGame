...
public:
	...
	virtual void CustomizeChildren(TSharedRef<IPropertyHandle> Property, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils) override;
...
protected:
	...
	* being customized.
	*/
	virtual void CachePrerequisites(TSharedRef<IPropertyHandle> PropertyHandle) = 0;
	...
	* being customized.
	*/
	virtual void SetUpPropertyChangeEvent(TSharedRef<IPropertyHandle> PropertyHandle) = 0;
...
protected:
	...
	*/
	void GetTargetObjects(TSharedRef<IPropertyHandle> PropertyHandle, TSharedPtr<IPropertyUtilities> Utils);
	...
	*/
	void CreateDefaultHeader(TSharedRef<IPropertyHandle> PropertyHandle, FDetailWidgetRow& HeaderRow);
